...
def process_help_command(message):
    ...
    help_text = (
        "💬 <b>Есть вопросы?</b>\n\n"
        "Напиши <b>@glore4</b> в Telegram\n\n"
        "Ответим в течение <b>рабочего часа</b>"
    )
...
def send_welcome_internal(message):
    ...
    welcome_text = (
        f"👋 Привет, {user_name}!\n\n"
        f"Я бот <b>AI2BIZ</b> – помогаю бизнесам <b>увеличивать выручку через автоматизацию продаж</b> и не терять лидов.\n\n"

        f"🎯 <b>Что я могу для тебя:</b>\n"
        f"1️⃣ Отправить <b>практические материалы</b> по автоматизации, которые помогут:\n"
        ...
        f"2️⃣ Записать тебя на <b>бесплатную консультацию</b> с экспертом AI2BIZ, где мы разберем:\n"
        ...
        f"📚 Напиши <b>«материалы»</b> → получить бесплатные гайды\n"
...
def commands_command(message):
    ...
    commands_text = (
        ...
        "Или просто напиши:\n"
        "<b>материалы</b> – получить бесплатные материалы\n"
...
def handle_message(message):
    ...
    if any(word in text for word in ["материал", "материалы", "файлы", "документ", "pdf", "гайд"]):
        subscription_text = (
            ...
            f"🔐 Это защита от спама и гарантия качества контента.\n\n"
    ...
    if any(
        ...
        consultation_text = (
            f"📞 <b>Запись на БЕСПЛАТНУЮ консультацию</b>\n\n"
    ...
    help_text = (
        ...
        f"📚 <b>материалы</b> – получить бесплатные гайды\n"
...
def handle_subscription(call):
    ...
    file_selection_text = (
        ...
        f"🔴 <b>5 ошибок менеджеров</b> – как быстро найти утечки в воронке\n"
        f"📋 <b>Чек-лист диагностики</b> – самопроверка за 15 минут"
    )
    ...
    try:
        if app_data.get("file_type") == "5_mistakes":
            ...
            file_description = (
                ...
                f"💡 <b>Экономия:</b> за счет исправления этих ошибок клиенты AI2BIZ экономят от 200K в месяц только на потерях."
            )
        else:
        ...
        consultation_offer = (
            ...
            f"На <b>бесплатной консультации</b> мы разберем:\n"
...
def finish_form_consultation(message, user_id):
    ...
    confirmation = (
        ...
        f"⏳ <b>Менеджер AI2BIZ свяжется с тобой в Telegram в течение рабочего часа</b> и согласует точное время встречи.\n\n"
        ...
        f"Подпишись на канал <b>@it_ai2biz</b> для эксклюзивных материалов и кейсов 📣"
    )
