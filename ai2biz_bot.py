#!/usr/bin/env python3
"""
AI2BIZ Telegram Bot - Alternative Version
Загружает файлы из Supabase Storage
Простая версия без Flask (альтернатива к main.py)
"""
...
print("🚀 AI2BIZ Bot started!")
print(f"📄 File 1: {FILE_5_MISTAKES[:60]}...")
print(f"📄 File 2: {FILE_CHECKLIST[:60]}...")

# ===== SUPABASE ФУНКЦИИ =====
def save_to_supabase(table, data):
    """Сохраняет данные в Supabase"""
    if not SUPABASE_URL or not SUPABASE_KEY:
        print(f"⚠️ Supabase not configured. Data not saved: {data}")
        return False
